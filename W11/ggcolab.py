...
train["ae"]["x"], train["ae"]["y"], x_benign_val, y_benign_val, _, _, x_malicious_train, y_malicious_train, _, _, _, _, _ = util.load_data(clean_dir, sample_size=1948,train_size=1000000, val_size=200000, test_size=150000)
...
threshold_b =  -0.11219793702129796 # F8 100k
...
# Extension stage
threshold_u = -0.017581426530704963# 0.8 100k
