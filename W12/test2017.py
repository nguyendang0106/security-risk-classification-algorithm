...
threshold_b =  -0.10866126632226556 # F3 100k
...
threshold_m = 0.44 # See table above
...
# Extension stage
threshold_u = -0.00015517209205490046# 0.995 + 0.1 100k
...
threshold_m = 0.46 # See table above
