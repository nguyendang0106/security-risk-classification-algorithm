...
stratified_split_and_save(
    'W9/data1/clean/all_benign.parquet',
    'W9/data1/train/all_benign.parquet',
    'W9/data1/test/all_benign.parquet',
    label_col
)

# Malicious
stratified_split_and_save(
    'W9/data1/clean/all_malicious.parquet',
    'W9/data1/train/all_malicious.parquet',
    'W9/data1/test/all_malicious.parquet',
    label_col
)
