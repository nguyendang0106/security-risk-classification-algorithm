...
# Load the data
test = pd.read_parquet("W9/dataTest2018/sampled_CSE-CIC-IDS-2018_mapped_1000_per_group.parquet")
...
label_mapping_2018 = {
    ...
    'FTP-BruteForce': 'Brute Force', # Assuming this exists in data2
...
x = test.drop(columns=['Label', 'Timestamp', 'Protocol', 'Group'])
...
tau_b = -0.13366126632226556
tau_m = 0.50
tau_u = -0.145517209205490046
...
plot_confusion_matrix(y, y_pred, labels=final_evaluation_categories, title="Confusion Matrix for 2018 Data (excluding Port Scan)")
plt.show()
