...
# Define file paths
benign_file_path = "W9/data1/test2/all_benign.parquet"
malicious_file_path = "W9/data1/test2/all_malicious.parquet"
output_dir = "W9/data1/test2/combined_mapped_data" # Directory to save the output
